...
class Topic{
    ...
    #assistence_hints = [
                            ...
                            lable: 'Мебель'},
                            {value: {topic: 'Музыкальные инструменты',
    ...
    get assistence_hints(){
        return this.#assistence_hints;
    }
