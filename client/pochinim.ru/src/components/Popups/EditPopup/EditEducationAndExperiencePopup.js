...
const EditEducationAndExperiencePopup = ({active, name, setActive, updateFunction, fieldToUpdate, idUser, setReloadPage, value}) =>{
    ...
    useEffect(() => {
        if(checkbox?.type == 'checkbox' && checkbox?.value == 'new'){
            setChecked(true);
            if(newSercices != '' && newPrice != null){
                console.log(newSercices, newPrice);
            ...
            <div className='children-popup'>
                ...
                <div className="edit-popup-list-of-sercices-prices" onChange={
                    ...
                    <div className="edit-popup-sercice-price">
                        ...
                        <input type='date' placeholder={0} value={newPrice} onChange={e => setNewPrice(e.target.value)}></input>
                    </div>
                </div>
            </div>
...
export default EditEducationAndExperiencePopup;